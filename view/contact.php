...
<body>
    ...
    <section class="ab-info-main py-5">
        <div class="container py-3">
            <h3 class="tittle text-center"><span class="sub-tittle">Find Us</span>LIÊN HỆ CHÚNG TÔI</h3>
            <div class="row contact-main-info mt-5">
                <div class="col-md-6 contact-right-content">
                    <form action="#" method="post">
                        <input type="text" name="Name" placeholder="Họ và tên" required="">
                        <input type="email" class="email" name="Email" placeholder="Địa chỉ email" required="">
                ...
                <div class="col-md-6 contact-left-content">
                    <div class="address-con">
                        <h4 class="mb-2"><span class="fa fa-phone-square" aria-hidden="true"></span>Điện thoại</h4>
                        <p>+84 359 905 982</p>
                        <p>+84 914 905 982</p>
                    </div>
                    <div class="address-con my-4">
                        <h4 class="mb-2"><span class="fa fa-envelope-o" aria-hidden="true"></span> Email </h4>
                        <p><a href="mailto:info@example.com">buibaoduyxs234@gmail.com</a></p>
                        <p><a href="mailto:info@example.com">duybbps31947@fpr.edu.vn</a></p>
                    </div>
                    ...
                    <div class="address-con">
                        ...
                        <p>55/19 Đường số 2, phường 3,quận Gò Vấp</p>
                    </div>
